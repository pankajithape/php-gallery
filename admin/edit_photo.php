        ...
        <form action="" method="post">
          <div class="col-md-8">
            <div class="form-group">
              <input type="text" name="title" class="form-control" value="<?php echo $photo->title; ?>"></input>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea id="summernote" cols="30" rows="10" class="form-control" type="text" name="description">
